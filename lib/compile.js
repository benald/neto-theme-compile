...
class NetoThemeCompiler {
        ...
        return fs.pathExists(masterPath)
            .then(exists => {
                if (exists) {
                    ...
                    this.log(`Cloning master source from ${this.options.masterRepo.magenta.underline} into ${masterPath.magenta}`);
    ...
    compileFile(file) {
        ...
        return fs.copy(srcFile, distFile)
            .then(() => this.log(`File compiled from source: ${srcFile.magenta}`))
            ...
            .catch(err => {
                ...
                return fs.copy(masterFile, distFile)
                    .then(() => this.log(`File compiled from master source: ${srcFile.magenta}`))
                    ...
                    .catch(err => {
                        ...
                        return fs.remove(distFile)
                            .then(() => this.log(`File removed: ${srcFile.magenta}`))
